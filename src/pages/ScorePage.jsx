...
export default function ScorePage() {
  ...
  if (!oiseaux) {
    return <div className="alert alert-info">Chargement des oiseaux...</div>;
  }
  if (!storage) {
    return <div className="alert alert-info">Aucune donnée de score disponible - {JSON.stringify(storage)}</div>;
  }
  try {
